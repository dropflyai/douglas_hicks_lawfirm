...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100">
      {/* Navigation */}
      <nav className="relative bg-white/95 backdrop-blur-xl border-b border-gray-200 shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/practice-areas" className="text-gray-600 hover:text-gray-900 transition-colors">Practice Areas</Link>
              ...
              <Link href="/portal" className="text-gray-600 hover:text-gray-900 transition-colors">Portal</Link>
              <Link 
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-white/70 via-blue-100/60 to-white/70"></div>
        </div>
        ...
        <div className={`relative z-10 text-center max-w-6xl mx-auto px-4 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
          ...
          <h1 className="text-6xl md:text-8xl font-black mb-8 leading-tight">
            <span className="text-gray-800">BILLION</span>
            <br />
            <span className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 bg-clip-text text-transparent animate-pulse">
              DOLLAR
            </span>
            <br />
            <span className="text-gray-800">LAWYERS</span>
          </h1>
