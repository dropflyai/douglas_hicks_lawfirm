...
const CaseManagerDashboard = ({ userRole, aiActive, setAiActive }) => {
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Case Manager Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-900 p-6 rounded-3xl border border-gray-700">
            <h3 className="font-semibold mb-2">Discovery Due</h3>
          ...
          <div className="bg-gray-900 p-6 rounded-3xl border border-gray-700">
            <h3 className="font-semibold mb-2">Vendors Active</h3>
